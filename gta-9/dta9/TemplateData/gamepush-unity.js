    ...
    class e {
        constructor(e) {
            this.gp = e, this.gp.player.on("change", (() => this.trigger("CallPlayerChange"))), this.gp.player.on("sync", (e => {
                ...
                e ? this.trigger("CallPlayerFetchFieldsComplete", JSON.stringify(this.gp.player.fields.map((e => ({ ...e,
        ...
        AppRequestReview() {
            return this.gp.app.requestReview().then((e => {
                e.success ? this.trigger("CallReviewResult", e.rating) : this.trigger("CallReviewClose", e.error)
            }))
        }
        AppCanRequestReview() {
        ...
        AppAddShortcut() {
            return this.gp.app.addShortcut().then((e => this.trigger("CallAddShortcut", e)))
        }
        AppCanAddShortcut() {
        ...
        LeaderboardFetch(e, t, s, r, n, i, a) {
            return this.gp.leaderboard.fetch({
                ...
                this.trigger("CallLeaderboardFetchTag", e), this.trigger("CallLeaderboardFetch", JSON.stringify(t.players)), this.trigger("CallLeaderboardFetchTop", JSON.stringify(t.topPlayers)), this.trigger("CallLeaderboardFetchAbove", JSON.stringify(t.abovePlayers)), this.trigger("CallLeaderboardFetchBelow", JSON.stringify(t.belowPlayers)), this.trigger("CallLeaderboardFetchOnlyPlayer", JSON.stringify(t.player))
            })).catch((e => {
        ...
        LeaderboardFetchPlayerRating(e, t, s) {
            return this.gp.leaderboard.fetchPlayerRating({
                ...
                this.trigger("CallLeaderboardFetchPlayerTag", e), this.trigger("CallLeaderboardFetchPlayerRating", t.player.position)
            })).catch((e => {
                console.warn(e), this.trigger("CallLeaderboardFetchPlayerError")
            }))
        }
        LeaderboardScopedOpen(e, t, s, r, n, i, a, l) {
            const h = parseInt(e, 10) || 0,
                o = h > 0 ? {
                    id: h
                } : {
                    tag: e
                };
            return this.gp.leaderboard.openScoped({ ...o,
                variant: t,
                order: s,
                limit: r,
                includeFields: i.split(",").map((e => e.trim())).filter((e => e)),
        ...
        LeaderboardScopedFetch(e, t, s, r, n, i, a) {
            ...
            return this.gp.leaderboard.fetchScoped({ ...h,
                variant: t,
                order: s,
                limit: r,
                includeFields: i.split(",").map((e => e.trim())).filter((e => e)),
                ...
                this.trigger("CallLeaderboardScopedFetchTag", e), this.trigger("CallLeaderboardScopedFetchVariant", t), this.trigger("CallLeaderboardScopedFetch", JSON.stringify(s.players)), this.trigger("CallLeaderboardScopedFetchTop", JSON.stringify(s.topPlayers)), this.trigger("CallLeaderboardScopedFetchAbove", JSON.stringify(s.abovePlayers)), this.trigger("CallLeaderboardScopedFetchBelow", JSON.stringify(s.belowPlayers)), this.trigger("CallLeaderboardScopedFetchOnlyPlayer", JSON.stringify(s.player))
            })).catch((e => {
        ...
        LeaderboardScopedPublishRecord(e, t, s, r, n, i, a, l, h) {
            ...
            return this.gp.leaderboard.publishRecord({ ...g,
                variant: t,
                override: Boolean(s),
                record: {
                    [r]: n,
        ...
        LeaderboardScopedFetchPlayerRating(e, t, s) {
            ...
            return this.gp.leaderboard.fetchPlayerRatingScoped({ ...n,
                variant: t,
                includeFields: s.split(",").map((e => e.trim())).filter((e => e))
            }).then((s => {
                this.trigger("CallLeaderboardScopedFetchPlayerTag", e), this.trigger("CallLeaderboardScopedFetchPlayerVariant", t), this.trigger("CallLeaderboardScopedFetchPlayerRating", s.player.position)
            })).catch((e => {
                console.warn(e), this.trigger("CallLeaderboardFetchPlayerError")
            }))
        }
        ...
        AchievementsSetProgress(e, t) {
            ...
            return this.gp.achievements.setProgress({ ...r,
                progress: t
            }).then((t => {
        ...
        HappyTime() {
            "CRAZY_GAMES" == this.gp.platform.type && this.gp.platform.getNativeSDK().game.happytime()
        }
        IsMobile() {
